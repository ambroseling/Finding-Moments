...
public struct BytePair: Hashable {
    let a: String
    let b: String
    ...
    public static func == (lhs: BytePair, rhs: BytePair) -> Bool {
...
public let byteEncoder: Dictionary<UTF8.CodeUnit, String> = [
    33: "!",
    34: "\"",
    35: "#",
    36: "$",
...
public let byteDecoder = Utils.invert(byteEncoder)
...
class CLIPTokenizer {
    ...
    func byteEncode(text: String) -> [String] {
        ...
        do {
            ...
            let tokens = matches.map { nsText.substring(with: $0.range) }
